...
function ForgotPwd() {
    ...
    return (
        <div>
            <div className='forgot-pwd-sec'>
                <div className='forgot-col left-col'>
                    <img height="300px" src={logo} alt="Cognizance Logo" />
                </div>
                <div className='forgot-col right-col'>
                    <div className='forgot-text'>
                        <div className='forgot-back-btn'><Link to="/login">
                    ...
                    <form onSubmit={handleSetPwd}>
                        ...
                        <input type="password" value={newPwd} onChange={handleNewPwd} placeholder='Enter New Password' ></input>
                        <input type="password" value={confPwd} onChange={handleConfPwd} placeholder='Confirm New Password'></input>
